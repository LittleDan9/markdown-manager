...
class ExportServiceClient:
    """HTTP client for communicating with the export service (PDF and diagram exports)."""

    def __init__(self, export_service_url: Optional[str] = None):
        # Use environment variable or default to localhost for development
        self.base_url = export_service_url or os.getenv(
...
export_service_client = ExportServiceClient()
